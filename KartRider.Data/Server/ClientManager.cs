...
public static class ClientManager
{
    ...
    public static void AddClient(SessionGroup session)
    {
        ...
        {
            Korean5136Protocol.BindSession(session, clientId);
        }
        ...
        if (ClientBuildProfiles.Active.Build == ClientBuild.Korean5136)
        {
            // P5136 resets its channel-connection receive queue immediately
            // before opening the endpoint returned by PrChannelSwitch. On a
